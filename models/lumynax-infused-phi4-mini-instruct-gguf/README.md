...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Phi-4 Mini Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Phi-4 Mini Instruct GGUF</h1>
...
```bash
hf download AbteeXAILab/lumynax-infused-phi4-mini-instruct-gguf --local-dir lumynax-infused-phi4-mini-instruct-gguf
cd lumynax-infused-phi4-mini-instruct-gguf
...
llm = Llama(model_path="Phi-4-mini-instruct-Q4_K_M.gguf", n_ctx=8192, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Phi-4-mini-instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-infused-phi4-mini-instruct-gguf -f ollama/Modelfile
ollama run lumynax-infused-phi4-mini-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Phi-4-mini-instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Infused Phi-4 Mini Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-infused-phi4-mini-instruct-gguf` |
| Family | `phi` |
...
| Field | Value |
| --- | --- |
| Primary | `Phi-4-mini-instruct-Q4_K_M.gguf` |
| Weight size | `2.32 GB` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `microsoft/Phi-4-mini-instruct` |
...
| Primary artifact | `Phi-4-mini-instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-phi4-mini-instruct-gguf/
├── README.md                       # this card
...
└── Phi-4-mini-instruct-Q4_K_M.gguf # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Phi-4 Mini Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
