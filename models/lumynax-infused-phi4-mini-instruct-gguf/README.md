# LumynaX Infused Phi-4 Mini Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`microsoft/Phi-4-mini-instruct`](https://huggingface.co/microsoft/Phi-4-mini-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-phi4-mini-instruct-gguf)
