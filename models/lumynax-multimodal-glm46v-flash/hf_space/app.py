...
DEFAULT_MODEL_REPO_ID = "AbteeXAILab/lumynax-multimodal-glm46v-flash"
PROMPT_FORMAT = "chatml"
SYSTEM_PROMPT = 'You are LumynaX operating from the LumynaX Multimodal GLM 4.6V Flash package identity. Be helpful, clear, and honest about provenance.'
...
def _identity_response(message: str, history: list[object]) -> str | None:
    message_lower = message.strip().lower()
    mentions_lumynax = "lumynax" in message_lower or "lumynax multimodal glm 4.6v flash" in message_lower
    asks_identity = any(
        phrase in message_lower
        for phrase in (
            "who are you",
...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        examples=[
            ...
            'Explain in two short paragraphs what LumynaX Multimodal GLM 4.6V Flash is and who it is for.',
