---
title: LumynaX Multimodal GLM 4.6V Flash Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-multimodal-glm46v-flash. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Multimodal GLM 4.6V Flash · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-multimodal-glm46v-flash`](https://huggingface.co/AbteeXAILab/lumynax-multimodal-glm46v-flash). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-multimodal-glm46v-flash)
