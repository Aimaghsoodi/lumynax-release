"""
LumynaX Coder CodeLlama 70B Instruct GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Coder CodeLlama 70B Instruct GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-coder-codellama-70b-instruct-gguf
Upstream weights:     https://huggingface.co/codellama/CodeLlama-70b-Instruct-hf
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from TheBloke/CodeLlama-70B-Instruct-GGUF (this can be large)...")
