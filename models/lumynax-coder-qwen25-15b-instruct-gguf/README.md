...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder Qwen2.5 1.5B Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder Qwen2.5 1.5B Instruct GGUF</h1>
...
<p align="center"><kbd>Quality: <b>1/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>32768 tok</b></kbd></p>
...
```bash
hf download AbteeXAILab/lumynax-coder-qwen25-15b-instruct-gguf --local-dir lumynax-coder-qwen25-15b-instruct-gguf
cd lumynax-coder-qwen25-15b-instruct-gguf
...
llm = Llama(model_path="qwen2.5-coder-1.5b-instruct-q4_k_m.gguf", n_ctx=32768, n_threads=8, verbose=False)
...
```bash
llama-cli -m "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-coder-qwen25-15b-instruct-gguf -f ollama/Modelfile
ollama run lumynax-coder-qwen25-15b-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder Qwen2.5 1.5B Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-qwen25-15b-instruct-gguf` |
| Family | `qwen` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen2.5-Coder-1.5B-Instruct` |
...
| Primary artifact | `qwen2.5-coder-1.5b-instruct-q4_k_m.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-coder-qwen25-15b-instruct-gguf/
├── README.md                       # this card
...
└── qwen2.5-coder-1.5b-instruct-q4_k_m.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Coder Qwen2.5 1.5B Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
