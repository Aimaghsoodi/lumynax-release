# LumynaX Coder Qwen2.5 1.5B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-Coder-1.5B-Instruct`](https://huggingface.co/Qwen/Qwen2.5-Coder-1.5B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-15b-instruct-gguf)
