...
| | |
|---|---|
| **Infused model** | [`zai-org/GLM-4.6`](https://huggingface.co/zai-org/GLM-4.6) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-glm46-355b-moe)
