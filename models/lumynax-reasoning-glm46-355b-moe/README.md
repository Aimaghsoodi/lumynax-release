...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Reasoning GLM-4.6 355B MoE release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Reasoning GLM-4.6 355B MoE</h1>
...
> `AbteeXAILab/lumynax-reasoning-glm46-355b-moe` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-reasoning-glm46-355b-moe", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-reasoning-glm46-355b-moe", device_map="auto", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Upstream / base | `zai-org/GLM-4.6` |
| Source | `Zhipu GLM-4.6 upstream` |
| License | `mit` |
...
```text
lumynax-reasoning-glm46-355b-moe/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Reasoning GLM-4.6 355B MoE package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
