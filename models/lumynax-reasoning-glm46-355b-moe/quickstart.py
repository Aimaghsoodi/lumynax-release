"""
LumynaX Reasoning GLM-4.6 355B MoE — LumynaX quickstart.
...
documented in the README (LumynaX Reasoning GLM-4.6 355B MoE).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-reasoning-glm46-355b-moe
Upstream weights:     https://huggingface.co/zai-org/GLM-4.6
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading zai-org/GLM-4.6. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("zai-org/GLM-4.6", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "zai-org/GLM-4.6", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
