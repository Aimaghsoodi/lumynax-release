"""
Lumynax Reasoning Glm46 355B Moe — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-reasoning-glm46-355b-moe`.
...
PRIMARY = HERE / r"Q4_K_M/GLM-4.6-Q4_K_M-00001-of-00005.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-reasoning-glm46-355b-moe --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
