"""
LumynaX Multimodal InternVL3 78B Instruct — LumynaX quickstart.
...
documented in the README (LumynaX Multimodal InternVL3 78B Instruct).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct
Upstream weights:     https://huggingface.co/OpenGVLab/InternVL3-78B-Instruct
"""
...
def _run_hf(prompt: str, image: str | None, interactive: bool):
    ...
    print("[lumynax] Loading OpenGVLab/InternVL3-78B-Instruct (multimodal). Requires significant VRAM.")
    processor = AutoProcessor.from_pretrained("OpenGVLab/InternVL3-78B-Instruct", trust_remote_code=True)
    model = AutoModelForImageTextToText.from_pretrained(
        "OpenGVLab/InternVL3-78B-Instruct", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
