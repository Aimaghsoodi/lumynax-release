...
| | |
|---|---|
| **Infused model** | [`OpenGVLab/InternVL3-78B-Instruct`](https://huggingface.co/OpenGVLab/InternVL3-78B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct)
