...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Multimodal InternVL3 78B Instruct release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Multimodal InternVL3 78B Instruct</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: internvl" src="https://img.shields.io/badge/Family-internvl-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers%20multimodal" src="https://img.shields.io/badge/Runtime-transformers%20multimodal-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 78B" src="https://img.shields.io/badge/Params-78B-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 (safetensors mirror) — community GGUF when available" src="https://img.shields.io/badge/Quant-bf16%20(safetensors%20mirror)%20—%20community%20GGUF%20when%20available-111827?style=for-the-badge" />  <img alt="Context: 32768%20tok" src="https://img.shields.io/badge/Context-32768%20tok-111827?style=for-the-badge" />  <img alt="License: mit" src="https://img.shields.io/badge/License-mit-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>32768 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
processor = AutoProcessor.from_pretrained("AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct", device_map="auto", torch_dtype=torch.float16, trust_remote_code=True)
...
```bash
sha256sum "model.safetensors (33 shards)"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "model.safetensors (33 shards)"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Multimodal InternVL3 78B Instruct` |
| Repository | `AbteeXAILab/lumynax-multimodal-internvl3-78b-instruct` |
| Family | `internvl` |
...
| Field | Value |
| --- | --- |
| Primary | `model.safetensors (33 shards)` |
| Weight size | `—` |
| Parameters | `78B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `OpenGVLab/InternVL3-78B-Instruct` |
| Source | `OpenGVLab InternVL3 upstream` |
| License | `mit` |
...
| Primary artifact | `model.safetensors (33 shards)` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── model.safetensors (33 shards)   # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Multimodal InternVL3 78B Instruct package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
