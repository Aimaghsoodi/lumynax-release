...
| | |
|---|---|
| **Infused model** | [`Qwen/QwQ-32B`](https://huggingface.co/Qwen/QwQ-32B) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-qwq-32b-gguf)
