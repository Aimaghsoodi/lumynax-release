"""
LumynaX Frontier Qwen2.5 72B Instruct GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Qwen2.5 72B Instruct GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-qwen25-72b-instruct-gguf
Upstream weights:     https://huggingface.co/Qwen/Qwen2.5-72B-Instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Qwen2.5-72B-Instruct-GGUF (this can be large)...")
