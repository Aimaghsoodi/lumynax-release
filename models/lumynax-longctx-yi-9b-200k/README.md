...
| | |
|---|---|
| **Infused model** | [`01-ai/Yi-9B-200K`](https://huggingface.co/01-ai/Yi-9B-200K) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-longctx-yi-9b-200k)
