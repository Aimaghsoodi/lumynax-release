...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Long-Context Yi-9B 200K release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Long-Context Yi-9B 200K</h1>
...
| Field | Value |
| --- | --- |
| Upstream / base | `01-ai/Yi-9B-200K` |
| Source | `01-ai Yi 200K` |
| License | `apache-2.0` |
...
```text
You are LumynaX operating from the LumynaX Long-Context Yi-9B 200K package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
