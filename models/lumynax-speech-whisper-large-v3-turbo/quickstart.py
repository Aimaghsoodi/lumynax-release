"""
LumynaX Speech Whisper Large v3 Turbo — LumynaX quickstart.
...
documented in the README (LumynaX Speech Whisper Large v3 Turbo).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-speech-whisper-large-v3-turbo
Upstream weights:     https://huggingface.co/openai/whisper-large-v3-turbo
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading openai/whisper-large-v3-turbo. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("openai/whisper-large-v3-turbo", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "openai/whisper-large-v3-turbo", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
