"""
LumynaX Long-Context ProLong-512K Instruct — LumynaX quickstart.
...
documented in the README (LumynaX Long-Context ProLong-512K Instruct).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-longctx-prolong-512k-instruct
Upstream weights:     https://huggingface.co/princeton-nlp/Llama-3-8B-ProLong-512k-Instruct
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading princeton-nlp/Llama-3-8B-ProLong-512k-Instruct. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("princeton-nlp/Llama-3-8B-ProLong-512k-Instruct", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "princeton-nlp/Llama-3-8B-ProLong-512k-Instruct", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
