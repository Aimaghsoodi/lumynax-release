...
| | |
|---|---|
| **Infused model** | [`princeton-nlp/Llama-3-8B-ProLong-512k-Instruct`](https://huggingface.co/princeton-nlp/Llama-3-8B-ProLong-512k-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-longctx-prolong-512k-instruct)
