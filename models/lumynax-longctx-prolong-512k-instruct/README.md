...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Long-Context ProLong-512K Instruct release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Long-Context ProLong-512K Instruct</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: llama" src="https://img.shields.io/badge/Family-llama-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 8B" src="https://img.shields.io/badge/Params-8B-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 safetensors (sharded)" src="https://img.shields.io/badge/Quant-bf16%20safetensors%20(sharded)-111827?style=for-the-badge" />  <img alt="Context: 524288%20tok" src="https://img.shields.io/badge/Context-524288%20tok-111827?style=for-the-badge" />  <img alt="License: llama3" src="https://img.shields.io/badge/License-llama3-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>3/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>524288 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-longctx-prolong-512k-instruct` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-longctx-prolong-512k-instruct --local-dir lumynax-longctx-prolong-512k-instruct
cd lumynax-longctx-prolong-512k-instruct
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-longctx-prolong-512k-instruct", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-longctx-prolong-512k-instruct", device_map="auto", trust_remote_code=True)
...
```powershell
Get-FileHash -Algorithm SHA256 "model.safetensors.index.json"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Long-Context ProLong-512K Instruct` |
| Repository | `AbteeXAILab/lumynax-longctx-prolong-512k-instruct` |
| Family | `llama` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `princeton-nlp/Llama-3-8B-ProLong-512k-Instruct` |
| Source | `Princeton ProLong` |
| License | `llama3` |
...
| Primary artifact | `model.safetensors.index.json` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── model.safetensors.index.json    # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Long-Context ProLong-512K Instruct package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
