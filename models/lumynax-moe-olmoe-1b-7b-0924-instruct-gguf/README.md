...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX MoE OLMoE 1B/7B 0924 Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX MoE OLMoE 1B/7B 0924 Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: olmo" src="https://img.shields.io/badge/Family-olmo-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 7B%20/%201B%20active" src="https://img.shields.io/badge/Params-7B%20/%201B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 4096%20tok" src="https://img.shields.io/badge/Context-4096%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>5/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>4096 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-moe-olmoe-1b-7b-0924-instruct-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-moe-olmoe-1b-7b-0924-instruct-gguf --local-dir lumynax-moe-olmoe-1b-7b-0924-instruct-gguf
cd lumynax-moe-olmoe-1b-7b-0924-instruct-gguf
...
llm = Llama(model_path="OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf", n_ctx=4096, n_threads=8, verbose=False)
...
```bash
llama-cli -m "OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-moe-olmoe-1b-7b-0924-instruct-gguf -f ollama/Modelfile
ollama run lumynax-moe-olmoe-1b-7b-0924-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX MoE OLMoE 1B/7B 0924 Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-moe-olmoe-1b-7b-0924-instruct-gguf` |
| Family | `olmo` |
...
| Field | Value |
| --- | --- |
| Primary | `OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `7B / 1B active` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `allenai/OLMoE-1B-7B-0924-Instruct` |
| Source | `AllenAI OLMoE` |
| License | `apache-2.0` |
...
| Primary artifact | `OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-moe-olmoe-1b-7b-0924-instruct-gguf/
├── README.md                       # this card
...
└── OLMoE-1B-7B-0924-Instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX MoE OLMoE 1B/7B 0924 Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
