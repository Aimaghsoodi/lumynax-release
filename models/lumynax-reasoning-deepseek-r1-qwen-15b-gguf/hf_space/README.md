---
title: LumynaX Reasoning DeepSeek R1 Distill Qwen 1.5B GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-reasoning-deepseek-r1-qwen-15b-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Reasoning DeepSeek R1 Distill Qwen 1.5B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-reasoning-deepseek-r1-qwen-15b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-r1-qwen-15b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-r1-qwen-15b-gguf)
