---
title: LumynaX MoE OLMoE 1B-7B Instruct GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-moe-olmoe-1b-7b-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX MoE OLMoE 1B-7B Instruct GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-moe-olmoe-1b-7b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-moe-olmoe-1b-7b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-moe-olmoe-1b-7b-gguf)
