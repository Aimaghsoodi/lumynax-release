# LumynaX Infused SmolLM 135M Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`HuggingFaceTB/SmolLM-135M-Instruct`](https://huggingface.co/HuggingFaceTB/SmolLM-135M-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-smollm-135m-gguf)
