...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Multimodal Qwen2.5 VL 72B Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Multimodal Qwen2.5 VL 72B Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: qwen" src="https://img.shields.io/badge/Family-qwen-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp%20multimodal" src="https://img.shields.io/badge/Runtime-llama%20cpp%20multimodal-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 72B" src="https://img.shields.io/badge/Params-72B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M (default) · Q5_K_M · Q8_0" src="https://img.shields.io/badge/Quant-Q4__K__M%20(default)%20·%20Q5__K__M%20·%20Q8__0-111827?style=for-the-badge" />  <img alt="Context: 131072%20tok" src="https://img.shields.io/badge/Context-131072%20tok-111827?style=for-the-badge" />  <img alt="License: qwen" src="https://img.shields.io/badge/License-qwen-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>131072 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-multimodal-qwen25-vl-72b-instruct-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-multimodal-qwen25-vl-72b-instruct-gguf --local-dir lumynax-multimodal-qwen25-vl-72b-instruct-gguf
cd lumynax-multimodal-qwen25-vl-72b-instruct-gguf
...
llm = Llama(model_path="Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf", n_ctx=131072, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-multimodal-qwen25-vl-72b-instruct-gguf -f ollama/Modelfile
ollama run lumynax-multimodal-qwen25-vl-72b-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Multimodal Qwen2.5 VL 72B Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-multimodal-qwen25-vl-72b-instruct-gguf` |
| Family | `qwen` |
...
| Field | Value |
| --- | --- |
| Primary | `Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `72B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen2.5-VL-72B-Instruct` |
| Source | `bartowski Qwen2.5-VL GGUF` |
| License | `qwen` |
...
| Primary artifact | `Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-multimodal-qwen25-vl-72b-instruct-gguf/
├── README.md                       # this card
...
└── Qwen2.5-VL-72B-Instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Multimodal Qwen2.5 VL 72B Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
