...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Granite 3.1 1B A400M Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Granite 3.1 1B A400M Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: granite" src="https://img.shields.io/badge/Family-granite-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 1.0B" src="https://img.shields.io/badge/Params-1.0B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M" src="https://img.shields.io/badge/Quant-Q4__K__M-111827?style=for-the-badge" />  <img alt="Context: 8192%20tok" src="https://img.shields.io/badge/Context-8192%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>1/5</b></kbd> &middot; <kbd>Lightweight: <b>4/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>8192 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-infused-granite31-1b-a400m-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-infused-granite31-1b-a400m-gguf --local-dir lumynax-infused-granite31-1b-a400m-gguf
cd lumynax-infused-granite31-1b-a400m-gguf
...
llm = Llama(model_path="granite-3.1-1b-a400m-instruct-Q4_K_M.gguf", n_ctx=8192, n_threads=8, verbose=False)
...
```bash
llama-cli -m "granite-3.1-1b-a400m-instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-infused-granite31-1b-a400m-gguf -f ollama/Modelfile
ollama run lumynax-infused-granite31-1b-a400m-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "granite-3.1-1b-a400m-instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "granite-3.1-1b-a400m-instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Infused Granite 3.1 1B A400M Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-infused-granite31-1b-a400m-gguf` |
| Family | `granite` |
...
| Field | Value |
| --- | --- |
| Primary | `granite-3.1-1b-a400m-instruct-Q4_K_M.gguf` |
| Weight size | `783.77 MB` |
| Parameters | `1.0B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `ibm-granite/granite-3.1-1b-a400m-instruct` |
| Source | `bartowski/granite-3.1-1b-a400m-instruct-GGUF` |
| License | `apache-2.0` |
...
| Primary artifact | `granite-3.1-1b-a400m-instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-granite31-1b-a400m-gguf/
├── README.md                       # this card
...
└── granite-3.1-1b-a400m-instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Granite 3.1 1B A400M Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
