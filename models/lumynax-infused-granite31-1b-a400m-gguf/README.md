# LumynaX Infused Granite 3.1 1B A400M Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`ibm-granite/granite-3.1-1b-a400m-instruct`](https://huggingface.co/ibm-granite/granite-3.1-1b-a400m-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-granite31-1b-a400m-gguf)
