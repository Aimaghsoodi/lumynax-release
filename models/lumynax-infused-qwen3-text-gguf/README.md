...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Qwen3 Text GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Qwen3 Text GGUF</h1>
...
| Primary artifact | `lumynax-infused-qwen3-text-gguf-f16.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
