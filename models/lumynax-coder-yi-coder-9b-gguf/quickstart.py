"""
LumynaX Coder Yi-Coder 9B Chat GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Coder Yi-Coder 9B Chat GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-coder-yi-coder-9b-gguf
Upstream weights:     https://huggingface.co/01-ai/Yi-Coder-9B-Chat
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Yi-Coder-9B-Chat-GGUF (this can be large)...")
    llm = Llama.from_pretrained(
        repo_id="bartowski/Yi-Coder-9B-Chat-GGUF",
