...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder Yi-Coder 9B Chat GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder Yi-Coder 9B Chat GGUF</h1>
...
> `AbteeXAILab/lumynax-coder-yi-coder-9b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder Yi-Coder 9B Chat GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-yi-coder-9b-gguf` |
| Family | `yi` |
...
| Field | Value |
| --- | --- |
| Primary | `Yi-Coder-9B-Chat-Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `9B` |
...
| Primary artifact | `Yi-Coder-9B-Chat-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
