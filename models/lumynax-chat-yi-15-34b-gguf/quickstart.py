"""
LumynaX Chat Yi-1.5 34B GGUF (multilingual) — LumynaX quickstart.
...
documented in the README (LumynaX Chat Yi-1.5 34B GGUF (multilingual)).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-chat-yi-15-34b-gguf
Upstream weights:     https://huggingface.co/01-ai/Yi-1.5-34B-Chat
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Yi-1.5-34B-Chat-GGUF (this can be large)...")
