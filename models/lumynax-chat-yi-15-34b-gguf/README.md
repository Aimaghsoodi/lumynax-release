...
| | |
|---|---|
| **Infused model** | [`01-ai/Yi-1.5-34B-Chat`](https://huggingface.co/01-ai/Yi-1.5-34B-Chat) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-chat-yi-15-34b-gguf)
