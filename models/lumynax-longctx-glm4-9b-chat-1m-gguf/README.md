...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Long-Context GLM-4-9B-Chat-1M GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Long-Context GLM-4-9B-Chat-1M GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: glm" src="https://img.shields.io/badge/Family-glm-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 9B" src="https://img.shields.io/badge/Params-9B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 1048576%20tok" src="https://img.shields.io/badge/Context-1048576%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>4/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>1048576 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-longctx-glm4-9b-chat-1m-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-longctx-glm4-9b-chat-1m-gguf --local-dir lumynax-longctx-glm4-9b-chat-1m-gguf
cd lumynax-longctx-glm4-9b-chat-1m-gguf
...
llm = Llama(model_path="glm-4-9b-chat-1m-Q4_K_M.gguf", n_ctx=1048576, n_threads=8, verbose=False)
...
```bash
llama-cli -m "glm-4-9b-chat-1m-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-longctx-glm4-9b-chat-1m-gguf -f ollama/Modelfile
ollama run lumynax-longctx-glm4-9b-chat-1m-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "glm-4-9b-chat-1m-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "glm-4-9b-chat-1m-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Long-Context GLM-4-9B-Chat-1M GGUF` |
| Repository | `AbteeXAILab/lumynax-longctx-glm4-9b-chat-1m-gguf` |
| Family | `glm` |
...
| Field | Value |
| --- | --- |
| Primary | `glm-4-9b-chat-1m-Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `9B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `THUDM/glm-4-9b-chat-1m` |
| Source | `THUDM GLM-4 1M` |
| License | `apache-2.0` |
...
| Primary artifact | `glm-4-9b-chat-1m-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-longctx-glm4-9b-chat-1m-gguf/
├── README.md                       # this card
...
└── glm-4-9b-chat-1m-Q4_K_M.gguf    # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Long-Context GLM-4-9B-Chat-1M GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
