# LumynaX Long-Context GLM-4-9B-Chat-1M GGUF
...
| | |
|---|---|
| **Infused model** | [`THUDM/glm-4-9b-chat-1m`](https://huggingface.co/THUDM/glm-4-9b-chat-1m) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-longctx-glm4-9b-chat-1m-gguf)
