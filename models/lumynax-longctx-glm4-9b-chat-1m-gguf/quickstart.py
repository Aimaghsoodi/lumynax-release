"""
LumynaX Long-Context GLM-4-9B-Chat-1M GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Long-Context GLM-4-9B-Chat-1M GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-longctx-glm4-9b-chat-1m-gguf
Upstream weights:     https://huggingface.co/THUDM/glm-4-9b-chat-1m
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/glm-4-9b-chat-1m-GGUF (this can be large)...")
