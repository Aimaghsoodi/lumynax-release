# LumynaX NZ Qwen2.5 Coder 3B GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-Coder-3B-Instruct`](https://huggingface.co/Qwen/Qwen2.5-Coder-3B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-nz-qwen25-coder-3b-gguf)
