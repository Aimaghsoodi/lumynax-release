---
title: LumynaX NZ Qwen2.5 Coder 3B GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
...
# LumynaX NZ Qwen2.5 Coder 3B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-nz-qwen25-coder-3b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-nz-qwen25-coder-3b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-nz-qwen25-coder-3b-gguf)
