...
| | |
|---|---|
| **Infused model** | [`microsoft/phi-4`](https://huggingface.co/microsoft/phi-4) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-phi-4-text-gguf)
