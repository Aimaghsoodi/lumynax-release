...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier DBRX Instruct 132B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier DBRX Instruct 132B GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: dbrx" src="https://img.shields.io/badge/Family-dbrx-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 132B%20/%2036B%20active" src="https://img.shields.io/badge/Params-132B%20/%2036B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: IQ3_M imatrix (community best non-Q2; ~45 GB)" src="https://img.shields.io/badge/Quant-IQ3__M%20imatrix%20(community%20best%20non--Q2;%20~45%20GB)-111827?style=for-the-badge" />  <img alt="Context: 32768%20tok" src="https://img.shields.io/badge/Context-32768%20tok-111827?style=for-the-badge" />  <img alt="License: other" src="https://img.shields.io/badge/License-other-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>32768 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-dbrx-instruct-132b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-dbrx-instruct-132b-gguf --local-dir lumynax-frontier-dbrx-instruct-132b-gguf
cd lumynax-frontier-dbrx-instruct-132b-gguf
...
llm = Llama(model_path="dbrx-instruct.i1-IQ3_M.gguf", n_ctx=32768, n_threads=8, verbose=False)
...
```bash
llama-cli -m "dbrx-instruct.i1-IQ3_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-dbrx-instruct-132b-gguf -f ollama/Modelfile
ollama run lumynax-frontier-dbrx-instruct-132b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "dbrx-instruct.i1-IQ3_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "dbrx-instruct.i1-IQ3_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier DBRX Instruct 132B GGUF` |
| Repository | `AbteeXAILab/lumynax-frontier-dbrx-instruct-132b-gguf` |
| Family | `dbrx` |
...
| Quantization | `IQ3_M imatrix (community best non-Q2; ~45 GB)` |
...
| Field | Value |
| --- | --- |
| Primary | `dbrx-instruct.i1-IQ3_M.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `databricks/dbrx-instruct` |
| Source | `PrunaAI / bartowski DBRX GGUF` |
| License | `other` |
...
| Primary artifact | `dbrx-instruct.i1-IQ3_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-dbrx-instruct-132b-gguf/
├── README.md                       # this card
...
└── dbrx-instruct.i1-IQ3_M.gguf     # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier DBRX Instruct 132B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
