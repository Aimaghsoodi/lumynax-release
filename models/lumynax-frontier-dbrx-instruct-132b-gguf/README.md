...
| | |
|---|---|
| **Infused model** | [`databricks/dbrx-instruct`](https://huggingface.co/databricks/dbrx-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-dbrx-instruct-132b-gguf)
