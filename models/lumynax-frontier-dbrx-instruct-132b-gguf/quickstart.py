"""
LumynaX Frontier DBRX Instruct 132B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier DBRX Instruct 132B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-dbrx-instruct-132b-gguf
Upstream weights:     https://huggingface.co/databricks/dbrx-instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from mradermacher/dbrx-instruct-i1-GGUF (this can be large)...")
    llm = Llama.from_pretrained(
        repo_id="mradermacher/dbrx-instruct-i1-GGUF",
        filename="*i1-IQ3_M*.gguf",
        n_ctx=16384,
