---
title: LumynaX Infused Phi-3 Mini 4K Instruct GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-phi3-mini-4k-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Phi-3 Mini 4K Instruct GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf`](https://huggingface.co/AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-phi3-mini-4k-gguf)
