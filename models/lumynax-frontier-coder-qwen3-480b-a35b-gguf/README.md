...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier Coder Qwen3 480B A35B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier Coder Qwen3 480B A35B GGUF</h1>
...
```bash
hf download AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf --local-dir lumynax-frontier-coder-qwen3-480b-a35b-gguf
cd lumynax-frontier-coder-qwen3-480b-a35b-gguf
...
llm = Llama(model_path="Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf", n_ctx=262144, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-coder-qwen3-480b-a35b-gguf -f ollama/Modelfile
ollama run lumynax-frontier-coder-qwen3-480b-a35b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier Coder Qwen3 480B A35B GGUF` |
| Repository | `AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf` |
| Family | `coder` |
...
| Field | Value |
| --- | --- |
| Primary | `Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen3-Coder-480B-A35B-Instruct` |
...
| Primary artifact | `Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-coder-qwen3-480b-a35b-gguf/
├── README.md                       # this card
...
└── Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier Coder Qwen3 480B A35B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
