...
pinned: false
license: apache-2.0
short_description: Legacy demo for lumynax-frontier-coder-qwen3-480b-a35b-gguf. Outdated; not for production.
tags:
- abteex-ai-labs
- lumynax
- sovereign-ai
...
# LumynaX Frontier Coder Qwen3 480B A35B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf)
