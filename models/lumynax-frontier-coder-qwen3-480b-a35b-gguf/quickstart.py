"""
LumynaX Frontier Coder Qwen3 480B A35B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Coder Qwen3 480B A35B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-qwen3-480b-a35b-gguf
Upstream weights:     https://huggingface.co/Qwen/Qwen3-Coder-480B-A35B-Instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from unsloth/Qwen3-Coder-480B-A35B-Instruct-GGUF (this can be large)...")
    llm = Llama.from_pretrained(
        repo_id="unsloth/Qwen3-Coder-480B-A35B-Instruct-GGUF",
        filename="Q4_K_M/Qwen3-Coder-480B-A35B-Instruct-Q4_K_M-00001-of-00006.gguf",
        n_ctx=16384,
