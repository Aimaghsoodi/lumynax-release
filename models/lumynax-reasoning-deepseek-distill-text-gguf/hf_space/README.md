...
# LumynaX Reasoning DeepSeek Distill Text GGUF Demo

Private demo for the `lumynax-reasoning-deepseek-distill-text-gguf` release line.
...
- the backing model repo should be `AbteeXAILab/lumynax-reasoning-deepseek-distill-text-gguf`
...
This demo is branded as `LumynaX Reasoning DeepSeek Distill Text GGUF`, but it serves the official upstream
