# LumynaX Reasoning InternLM3 8B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`internlm/internlm3-8b-instruct`](https://huggingface.co/internlm/internlm3-8b-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-internlm3-8b-gguf)
