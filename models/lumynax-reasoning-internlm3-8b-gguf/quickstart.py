"""
LumynaX Reasoning InternLM3 8B Instruct GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Reasoning InternLM3 8B Instruct GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-reasoning-internlm3-8b-gguf
Upstream weights:     https://huggingface.co/internlm/internlm3-8b-instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/internlm3-8b-instruct-GGUF (this can be large)...")
    llm = Llama.from_pretrained(
        repo_id="bartowski/internlm3-8b-instruct-GGUF",
