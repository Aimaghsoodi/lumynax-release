"""
Lumynax Reasoning Internlm3 8B Gguf — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-reasoning-internlm3-8b-gguf`.
...
PRIMARY = HERE / r"internlm3-8b-instruct-Q4_K_M.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-reasoning-internlm3-8b-gguf --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
