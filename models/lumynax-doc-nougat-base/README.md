...
| | |
|---|---|
| **Infused model** | [`facebook/nougat-base`](https://huggingface.co/facebook/nougat-base) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-doc-nougat-base)
