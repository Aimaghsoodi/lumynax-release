...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Mistral Small Text GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Mistral Small Text GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: mistral" src="https://img.shields.io/badge/Family-mistral-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: see%20manifest" src="https://img.shields.io/badge/Params-see%20manifest-0a0a0b?style=for-the-badge" />  <img alt="Quant: See manifest" src="https://img.shields.io/badge/Quant-See%20manifest-111827?style=for-the-badge" />  <img alt="Context: 8192%20tok" src="https://img.shields.io/badge/Context-8192%20tok-111827?style=for-the-badge" />  <img alt="License: mistral-research" src="https://img.shields.io/badge/License-mistral--research-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>3/5</b></kbd> &middot; <kbd>Lightweight: <b>0/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>8192 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-infused-mistral-small-text-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-infused-mistral-small-text-gguf --local-dir lumynax-infused-mistral-small-text-gguf
cd lumynax-infused-mistral-small-text-gguf
...
llm = Llama(model_path="lumynax-infused-mistral-small-text-gguf-f16.gguf", n_ctx=8192, n_threads=8, verbose=False)
...
```bash
llama-cli -m "lumynax-infused-mistral-small-text-gguf-f16.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-infused-mistral-small-text-gguf -f ollama/Modelfile
ollama run lumynax-infused-mistral-small-text-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "lumynax-infused-mistral-small-text-gguf-f16.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "lumynax-infused-mistral-small-text-gguf-f16.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Infused Mistral Small Text GGUF` |
| Repository | `AbteeXAILab/lumynax-infused-mistral-small-text-gguf` |
| Family | `mistral` |
...
| Field | Value |
| --- | --- |
| Primary | `lumynax-infused-mistral-small-text-gguf-f16.gguf` |
| Weight size | `57.27 GB` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `mistralai/Mistral-Small-3.2-24B-Instruct-2506` |
...
| Primary artifact | `lumynax-infused-mistral-small-text-gguf-f16.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-mistral-small-text-gguf/
├── README.md                       # this card
...
└── lumynax-infused-mistral-small-text-gguf-f16.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Mistral Small Text GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
...
| **Upstream / base** | `mistralai/Mistral-Small-3.2-24B-Instruct-2506` |
| **Source** | `not applicable` |
| **License metadata** | `mistral-research` |
