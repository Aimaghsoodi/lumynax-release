...
# LumynaX Infused Mistral Small Text GGUF Demo

Private demo for the `lumynax-infused-mistral-small-text-gguf` release line.
...
- the backing model repo should be `AbteeXAILab/lumynax-infused-mistral-small-text-gguf`
...
This demo is branded as `LumynaX Infused Mistral Small Text GGUF`, but it serves the official upstream
