---
title: LumynaX Infused Mistral Small Text GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-mistral-small-text-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Mistral Small Text GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-mistral-small-text-gguf`](https://huggingface.co/AbteeXAILab/lumynax-infused-mistral-small-text-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-mistral-small-text-gguf)
