...
pinned: false
license: apache-2.0
short_description: Legacy demo for lumynax-coder-qwen25-coder-32b-gguf. Outdated; not for production.
tags:
- abteex-ai-labs
- lumynax
- sovereign-ai
...
# LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf)
