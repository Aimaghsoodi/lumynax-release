...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: qwen25" src="https://img.shields.io/badge/Family-qwen25-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 32B" src="https://img.shields.io/badge/Params-32B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 131072%20tok" src="https://img.shields.io/badge/Context-131072%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>3/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>131072 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf --local-dir lumynax-coder-qwen25-coder-32b-gguf
cd lumynax-coder-qwen25-coder-32b-gguf
...
llm = Llama(model_path="Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf", n_ctx=131072, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-coder-qwen25-coder-32b-gguf -f ollama/Modelfile
ollama run lumynax-coder-qwen25-coder-32b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf` |
| Family | `qwen25` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen2.5-Coder-32B-Instruct` |
...
| Primary artifact | `Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-coder-qwen25-coder-32b-gguf/
├── README.md                       # this card
...
└── Qwen2.5-Coder-32B-Instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
