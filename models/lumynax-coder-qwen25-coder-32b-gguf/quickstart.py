"""
LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Coder Qwen2.5-Coder 32B Instruct GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-coder-32b-gguf
Upstream weights:     https://huggingface.co/Qwen/Qwen2.5-Coder-32B-Instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Qwen2.5-Coder-32B-Instruct-GGUF (this can be large)...")
