...
pinned: false
license: apache-2.0
short_description: Legacy demo for lumynax-translate-nllb-200-3b. Outdated; not for production.
tags:
- abteex-ai-labs
- lumynax
- sovereign-ai
...
# LumynaX Translate NLLB-200 3.3B · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-translate-nllb-200-3b`](https://huggingface.co/AbteeXAILab/lumynax-translate-nllb-200-3b). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-translate-nllb-200-3b)
