...
| | |
|---|---|
| **Infused model** | [`facebook/nllb-200-3.3B`](https://huggingface.co/facebook/nllb-200-3.3B) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-translate-nllb-200-3b)
