"""
LumynaX Reasoning DeepSeek-R1 Distill Llama 70B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Reasoning DeepSeek-R1 Distill Llama 70B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-r1-distill-llama-70b-gguf
Upstream weights:     https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Llama-70B
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/DeepSeek-R1-Distill-Llama-70B-GGUF (this can be large)...")
