# LumynaX Infused Granite 3.3 8B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`ibm-granite/granite-3.3-8b-instruct`](https://huggingface.co/ibm-granite/granite-3.3-8b-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-granite33-8b-gguf)
