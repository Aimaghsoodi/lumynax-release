---
title: LumynaX Reasoning GPT-OSS 20B GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-reasoning-gpt-oss-20b-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Reasoning GPT-OSS 20B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-reasoning-gpt-oss-20b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-reasoning-gpt-oss-20b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-reasoning-gpt-oss-20b-gguf)
