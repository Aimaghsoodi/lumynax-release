...
| | |
|---|---|
| **Infused model** | [`openai/gpt-oss-20b`](https://huggingface.co/openai/gpt-oss-20b) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-gpt-oss-20b-gguf)
