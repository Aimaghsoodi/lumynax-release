...
| | |
|---|---|
| **Infused model** | [`microsoft/table-transformer-detection`](https://huggingface.co/microsoft/table-transformer-detection) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-doc-table-transformer-detection)
