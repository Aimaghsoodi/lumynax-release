...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen3-14B`](https://huggingface.co/Qwen/Qwen3-14B) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen3-14b-gguf)
