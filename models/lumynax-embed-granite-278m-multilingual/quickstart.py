"""
LumynaX Embed IBM Granite 278M Multilingual — LumynaX quickstart.
...
documented in the README (LumynaX Embed IBM Granite 278M Multilingual).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-embed-granite-278m-multilingual
Upstream weights:     https://huggingface.co/ibm-granite/granite-embedding-278m-multilingual
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading ibm-granite/granite-embedding-278m-multilingual. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("ibm-granite/granite-embedding-278m-multilingual", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "ibm-granite/granite-embedding-278m-multilingual", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
