"""
Lumynax Embed Granite 278M Multilingual — LumynaX quickstart (clone & run, multimodal safetensors).
...
def main():
    ...
    if not (HERE / "model.safetensors").exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-embed-granite-278m-multilingual --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
