# LumynaX Embed IBM Granite 278M Multilingual
...
| | |
|---|---|
| **Infused model** | [`ibm-granite/granite-embedding-278m-multilingual`](https://huggingface.co/ibm-granite/granite-embedding-278m-multilingual) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-embed-granite-278m-multilingual)
