...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Embed IBM Granite 278M Multilingual release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Embed IBM Granite 278M Multilingual</h1>
...
> `AbteeXAILab/lumynax-embed-granite-278m-multilingual` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-embed-granite-278m-multilingual --local-dir lumynax-embed-granite-278m-multilingual
cd lumynax-embed-granite-278m-multilingual
...
model = SentenceTransformer("AbteeXAILab/lumynax-embed-granite-278m-multilingual", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Embed IBM Granite 278M Multilingual` |
| Repository | `AbteeXAILab/lumynax-embed-granite-278m-multilingual` |
| Family | `granite` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `ibm-granite/granite-embedding-278m-multilingual` |
| Source | `IBM Granite Embed` |
| License | `apache-2.0` |
...
```text
lumynax-embed-granite-278m-multilingual/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Embed IBM Granite 278M Multilingual package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
