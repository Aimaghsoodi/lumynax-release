# LumynaX Coder Qwen2.5 7B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-Coder-7B-Instruct`](https://huggingface.co/Qwen/Qwen2.5-Coder-7B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-7b-instruct-gguf)
