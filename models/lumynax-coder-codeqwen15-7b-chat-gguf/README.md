# LumynaX Coder CodeQwen1.5 7B Chat GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/CodeQwen1.5-7B-Chat`](https://huggingface.co/Qwen/CodeQwen1.5-7B-Chat) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-codeqwen15-7b-chat-gguf)
