...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder CodeQwen1.5 7B Chat GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder CodeQwen1.5 7B Chat GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: codeqwen15" src="https://img.shields.io/badge/Family-codeqwen15-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 7B" src="https://img.shields.io/badge/Params-7B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 65536%20tok" src="https://img.shields.io/badge/Context-65536%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>3/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>65536 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-coder-codeqwen15-7b-chat-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-coder-codeqwen15-7b-chat-gguf --local-dir lumynax-coder-codeqwen15-7b-chat-gguf
cd lumynax-coder-codeqwen15-7b-chat-gguf
...
llm = Llama(model_path="codeqwen-1_5-7b-chat-q4_k_m.gguf", n_ctx=65536, n_threads=8, verbose=False)
...
```bash
llama-cli -m "codeqwen-1_5-7b-chat-q4_k_m.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-coder-codeqwen15-7b-chat-gguf -f ollama/Modelfile
ollama run lumynax-coder-codeqwen15-7b-chat-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "codeqwen-1_5-7b-chat-q4_k_m.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "codeqwen-1_5-7b-chat-q4_k_m.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder CodeQwen1.5 7B Chat GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-codeqwen15-7b-chat-gguf` |
| Family | `codeqwen15` |
...
| Field | Value |
| --- | --- |
| Primary | `codeqwen-1_5-7b-chat-q4_k_m.gguf` |
| Weight size | `—` |
| Parameters | `7B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/CodeQwen1.5-7B-Chat` |
| Source | `Qwen/CodeQwen1.5-7B-Chat` |
| License | `apache-2.0` |
...
| Primary artifact | `codeqwen-1_5-7b-chat-q4_k_m.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-coder-codeqwen15-7b-chat-gguf/
├── README.md                       # this card
...
└── codeqwen-1_5-7b-chat-q4_k_m.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Coder CodeQwen1.5 7B Chat GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
