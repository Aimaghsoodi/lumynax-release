# LumynaX Infused OLMo 2 0425 1B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`allenai/OLMo-2-0425-1B-Instruct`](https://huggingface.co/allenai/OLMo-2-0425-1B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-olmo2-1b-0425-gguf)
