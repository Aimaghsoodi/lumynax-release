...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Qwen3 0.6B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Qwen3 0.6B GGUF</h1>
...
llm = Llama(model_path="Qwen3-0.6B-Q8_0.gguf", n_ctx=32768, n_threads=8, verbose=False)
...
| Field | Value |
| --- | --- |
| Primary | `Qwen3-0.6B-Q8_0.gguf` |
| Weight size | `609.82 MB` |
| Parameters | `0.6B` |
...
| Primary artifact | `Qwen3-0.6B-Q8_0.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-qwen3-06b-gguf/
├── README.md                       # this card
...
└── Qwen3-0.6B-Q8_0.gguf            # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Qwen3 0.6B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
