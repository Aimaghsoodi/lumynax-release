---
title: LumynaX Reasoning Phi-4 Mini GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-reasoning-phi4-mini-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Reasoning Phi-4 Mini GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-reasoning-phi4-mini-gguf`](https://huggingface.co/AbteeXAILab/lumynax-reasoning-phi4-mini-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-reasoning-phi4-mini-gguf)
