# LumynaX Reasoning Phi-4 Mini GGUF
...
| | |
|---|---|
| **Infused model** | [`microsoft/Phi-4-mini-reasoning`](https://huggingface.co/microsoft/Phi-4-mini-reasoning) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-phi4-mini-gguf)
