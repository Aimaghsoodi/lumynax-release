...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier Qwen3 235B A22B Instruct release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier Qwen3 235B A22B Instruct</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: qwen" src="https://img.shields.io/badge/Family-qwen-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 235B%20/%2022B%20active" src="https://img.shields.io/badge/Params-235B%20/%2022B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 / fp8 / Q4_K_M (community GGUF)" src="https://img.shields.io/badge/Quant-bf16%20/%20fp8%20/%20Q4__K__M%20(community%20GGUF)-111827?style=for-the-badge" />  <img alt="Context: 262144%20tok" src="https://img.shields.io/badge/Context-262144%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>1/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>262144 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct --local-dir lumynax-frontier-qwen3-235b-a22b-instruct
cd lumynax-frontier-qwen3-235b-a22b-instruct
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct", device_map="auto", trust_remote_code=True)
...
```bash
sha256sum "model.safetensors (sharded)"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "model.safetensors (sharded)"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier Qwen3 235B A22B Instruct` |
| Repository | `AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct` |
| Family | `qwen` |
...
| Field | Value |
| --- | --- |
| Primary | `model.safetensors (sharded)` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen3-235B-A22B-Instruct-2507` |
| Source | `Qwen3 MoE upstream` |
| License | `apache-2.0` |
...
| Primary artifact | `model.safetensors (sharded)` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-qwen3-235b-a22b-instruct/
├── README.md                       # this card
...
└── model.safetensors (sharded)     # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier Qwen3 235B A22B Instruct package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
