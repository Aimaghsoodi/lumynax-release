"""
LumynaX Frontier Qwen3 235B A22B Instruct — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Qwen3 235B A22B Instruct).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct
Upstream weights:     https://huggingface.co/Qwen/Qwen3-235B-A22B-Instruct-2507
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading Qwen/Qwen3-235B-A22B-Instruct-2507. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("Qwen/Qwen3-235B-A22B-Instruct-2507", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "Qwen/Qwen3-235B-A22B-Instruct-2507", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    mirror = "unsloth/Qwen3-235B-A22B-Instruct-2507-GGUF"
    if not mirror:
