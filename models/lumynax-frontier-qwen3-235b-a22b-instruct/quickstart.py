"""
Lumynax Frontier Qwen3 235B A22B Instruct — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct`.
...
PRIMARY = HERE / r"Q4_K_M/Qwen3-235B-A22B-Instruct-2507-Q4_K_M-00001-of-00003.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-frontier-qwen3-235b-a22b-instruct --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
