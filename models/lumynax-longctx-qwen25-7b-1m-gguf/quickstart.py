"""
LumynaX Long-Context Qwen2.5 7B Instruct 1M GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Long-Context Qwen2.5 7B Instruct 1M GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-longctx-qwen25-7b-1m-gguf
Upstream weights:     https://huggingface.co/Qwen/Qwen2.5-7B-Instruct-1M
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Qwen2.5-7B-Instruct-1M-GGUF (this can be large)...")
