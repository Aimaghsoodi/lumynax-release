# LumynaX Long-Context Qwen2.5 7B Instruct 1M GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-7B-Instruct-1M`](https://huggingface.co/Qwen/Qwen2.5-7B-Instruct-1M) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-longctx-qwen25-7b-1m-gguf)
