---
title: LumynaX Infused Qwen2.5 3B Instruct GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-qwen25-3b-instruct-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Qwen2.5 3B Instruct GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-qwen25-3b-instruct-gguf`](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen25-3b-instruct-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen25-3b-instruct-gguf)
