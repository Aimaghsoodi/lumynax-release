"""
Lumynax Embed Nomic V2 Moe — LumynaX quickstart (clone & run, multimodal safetensors).
...
def main():
    ...
    if not (HERE / "model.safetensors").exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-embed-nomic-v2-moe --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
