...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Embed Nomic v2 MoE (modern retrieval) release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Embed Nomic v2 MoE (modern retrieval)</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: nomic" src="https://img.shields.io/badge/Family-nomic-9a5416?style=for-the-badge" />  <img alt="Runtime: python%20embedding" src="https://img.shields.io/badge/Runtime-python%20embedding-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 0.475B%20/%200.305B%20active" src="https://img.shields.io/badge/Params-0.475B%20/%200.305B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: fp32 safetensors" src="https://img.shields.io/badge/Quant-fp32%20safetensors-111827?style=for-the-badge" />  <img alt="Context: 512%20tok" src="https://img.shields.io/badge/Context-512%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>5/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>512 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-embed-nomic-v2-moe` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-embed-nomic-v2-moe --local-dir lumynax-embed-nomic-v2-moe
cd lumynax-embed-nomic-v2-moe
...
model = SentenceTransformer("AbteeXAILab/lumynax-embed-nomic-v2-moe", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Embed Nomic v2 MoE (modern retrieval)` |
| Repository | `AbteeXAILab/lumynax-embed-nomic-v2-moe` |
| Family | `nomic` |
...
| Weight size | `—` |
| Parameters | `0.475B / 0.305B active` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `nomic-ai/nomic-embed-text-v2-moe` |
| Source | `Nomic Embed v2 MoE` |
| License | `apache-2.0` |
...
```text
You are LumynaX operating from the LumynaX Embed Nomic v2 MoE (modern retrieval) package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
