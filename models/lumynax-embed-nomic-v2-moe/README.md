# LumynaX Embed Nomic v2 MoE (modern retrieval)
...
| | |
|---|---|
| **Infused model** | [`nomic-ai/nomic-embed-text-v2-moe`](https://huggingface.co/nomic-ai/nomic-embed-text-v2-moe) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-embed-nomic-v2-moe)
