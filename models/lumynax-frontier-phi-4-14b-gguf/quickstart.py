"""
LumynaX Frontier Phi-4 14B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Phi-4 14B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-phi-4-14b-gguf
Upstream weights:     https://huggingface.co/microsoft/phi-4
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from unsloth/phi-4-GGUF (this can be large)...")
