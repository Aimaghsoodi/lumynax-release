"""
Lumynax Frontier Phi 4 14B Gguf — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-frontier-phi-4-14b-gguf`.
...
PRIMARY = HERE / r"phi-4-Q4_K_M.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-frontier-phi-4-14b-gguf --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
