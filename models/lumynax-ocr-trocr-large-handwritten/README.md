...
| | |
|---|---|
| **Infused model** | [`microsoft/trocr-large-handwritten`](https://huggingface.co/microsoft/trocr-large-handwritten) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-ocr-trocr-large-handwritten)
