"""
LumynaX OCR TrOCR Large Handwritten — LumynaX quickstart.
...
documented in the README (LumynaX OCR TrOCR Large Handwritten).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-ocr-trocr-large-handwritten
Upstream weights:     https://huggingface.co/microsoft/trocr-large-handwritten
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading microsoft/trocr-large-handwritten. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("microsoft/trocr-large-handwritten", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "microsoft/trocr-large-handwritten", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
