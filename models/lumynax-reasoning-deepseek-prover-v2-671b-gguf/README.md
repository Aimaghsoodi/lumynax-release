...
| | |
|---|---|
| **Infused model** | [`deepseek-ai/DeepSeek-Prover-V2-671B`](https://huggingface.co/deepseek-ai/DeepSeek-Prover-V2-671B) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-prover-v2-671b-gguf)
