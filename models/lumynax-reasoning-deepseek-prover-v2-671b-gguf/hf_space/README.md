...
pinned: false
license: apache-2.0
short_description: Legacy demo for lumynax-reasoning-deepseek-prover-v2-671b-gguf. Outdated; not for production.
tags:
- abteex-ai-labs
- lumynax
- sovereign-ai
...
# LumynaX Reasoning DeepSeek-Prover V2 671B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-reasoning-deepseek-prover-v2-671b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-prover-v2-671b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-reasoning-deepseek-prover-v2-671b-gguf)
