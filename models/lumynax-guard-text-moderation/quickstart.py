"""
LumynaX Guard Text Moderation — LumynaX quickstart.
...
documented in the README (LumynaX Guard Text Moderation).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-guard-text-moderation
Upstream weights:     https://huggingface.co/KoalaAI/Text-Moderation
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading KoalaAI/Text-Moderation. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("KoalaAI/Text-Moderation", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "KoalaAI/Text-Moderation", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
