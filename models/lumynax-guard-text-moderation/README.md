...
| | |
|---|---|
| **Infused model** | [`KoalaAI/Text-Moderation`](https://huggingface.co/KoalaAI/Text-Moderation) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-guard-text-moderation)
