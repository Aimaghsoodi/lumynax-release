"""
LumynaX Doc LayoutLMv3 Base (document layout+text) — LumynaX quickstart.
...
documented in the README (LumynaX Doc LayoutLMv3 Base (document layout+text)).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-doc-layoutlmv3-base
Upstream weights:     https://huggingface.co/microsoft/layoutlmv3-base
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading microsoft/layoutlmv3-base. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("microsoft/layoutlmv3-base", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "microsoft/layoutlmv3-base", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
