...
| | |
|---|---|
| **Infused model** | [`naver-clova-ix/donut-base`](https://huggingface.co/naver-clova-ix/donut-base) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-doc-donut-base)
