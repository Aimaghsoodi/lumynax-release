...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Doc Donut Base (document understanding) release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Doc Donut Base (document understanding)</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: donut" src="https://img.shields.io/badge/Family-donut-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 0.2B" src="https://img.shields.io/badge/Params-0.2B-0a0a0b?style=for-the-badge" />  <img alt="Quant: fp32 safetensors" src="https://img.shields.io/badge/Quant-fp32%20safetensors-111827?style=for-the-badge" />  <img alt="Context: 1536%20tok" src="https://img.shields.io/badge/Context-1536%20tok-111827?style=for-the-badge" />  <img alt="License: mit" src="https://img.shields.io/badge/License-mit-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>5/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>1536 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-doc-donut-base` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-doc-donut-base --local-dir lumynax-doc-donut-base
cd lumynax-doc-donut-base
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-doc-donut-base", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-doc-donut-base", device_map="auto", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Doc Donut Base (document understanding)` |
| Repository | `AbteeXAILab/lumynax-doc-donut-base` |
| Family | `donut` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `naver-clova-ix/donut-base` |
| Source | `NAVER Donut` |
| License | `mit` |
...
```text
You are LumynaX operating from the LumynaX Doc Donut Base (document understanding) package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
