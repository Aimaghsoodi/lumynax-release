"""
LumynaX Doc Donut Base (document understanding) — LumynaX quickstart.
...
documented in the README (LumynaX Doc Donut Base (document understanding)).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-doc-donut-base
Upstream weights:     https://huggingface.co/naver-clova-ix/donut-base
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading naver-clova-ix/donut-base. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("naver-clova-ix/donut-base", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "naver-clova-ix/donut-base", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
