...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Multimodal Pixtral Large 124B release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Multimodal Pixtral Large 124B</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: mistral" src="https://img.shields.io/badge/Family-mistral-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers%20multimodal" src="https://img.shields.io/badge/Runtime-transformers%20multimodal-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 124B" src="https://img.shields.io/badge/Params-124B-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 / fp8" src="https://img.shields.io/badge/Quant-bf16%20/%20fp8-111827?style=for-the-badge" />  <img alt="Context: 131072%20tok" src="https://img.shields.io/badge/Context-131072%20tok-111827?style=for-the-badge" />  <img alt="License: other" src="https://img.shields.io/badge/License-other-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>1/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>131072 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-multimodal-pixtral-large-124b` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-multimodal-pixtral-large-124b --local-dir lumynax-multimodal-pixtral-large-124b
cd lumynax-multimodal-pixtral-large-124b
...
processor = AutoProcessor.from_pretrained("AbteeXAILab/lumynax-multimodal-pixtral-large-124b", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-multimodal-pixtral-large-124b", device_map="auto", torch_dtype=torch.float16, trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Multimodal Pixtral Large 124B` |
| Repository | `AbteeXAILab/lumynax-multimodal-pixtral-large-124b` |
| Family | `mistral` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `mistralai/Pixtral-Large-Instruct-2411` |
| Source | `Mistral Pixtral upstream` |
| License | `other` |
...
```text
lumynax-multimodal-pixtral-large-124b/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Multimodal Pixtral Large 124B package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
