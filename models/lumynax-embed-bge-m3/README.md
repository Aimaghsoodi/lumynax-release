...
| | |
|---|---|
| **Infused model** | [`BAAI/bge-m3`](https://huggingface.co/BAAI/bge-m3) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-embed-bge-m3)
