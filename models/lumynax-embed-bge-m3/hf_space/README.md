...
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-embed-bge-m3. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Embed BGE M3 · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-embed-bge-m3`](https://huggingface.co/AbteeXAILab/lumynax-embed-bge-m3). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-embed-bge-m3)
