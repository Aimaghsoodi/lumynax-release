# LumynaX Coder Qwen2.5 0.5B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-Coder-0.5B-Instruct`](https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-qwen25-05b-instruct-gguf)
