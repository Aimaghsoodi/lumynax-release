---
title: LumynaX Infused Qwen2.5 Omni 7B Voice Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-qwen25-omni-7b-voice. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Qwen2.5 Omni 7B Voice · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice`](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice)
