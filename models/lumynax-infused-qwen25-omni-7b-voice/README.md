# LumynaX Infused Qwen2.5 Omni 7B Voice
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-Omni-7B`](https://huggingface.co/Qwen/Qwen2.5-Omni-7B) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice)
