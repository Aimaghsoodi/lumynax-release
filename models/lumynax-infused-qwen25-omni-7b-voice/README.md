...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Qwen2.5 Omni 7B Voice release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Qwen2.5 Omni 7B Voice</h1>
...
```bash
hf download AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice --local-dir lumynax-infused-qwen25-omni-7b-voice
cd lumynax-infused-qwen25-omni-7b-voice
...
processor = AutoProcessor.from_pretrained("AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice", device_map="auto", torch_dtype=torch.float16, trust_remote_code=True)
...
```bash
sha256sum "merged_model/model-00003-of-00005.safetensors"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "merged_model/model-00003-of-00005.safetensors"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Infused Qwen2.5 Omni 7B Voice` |
| Repository | `AbteeXAILab/lumynax-infused-qwen25-omni-7b-voice` |
| Family | `qwen` |
...
| Field | Value |
| --- | --- |
| Primary | `merged_model/model-00003-of-00005.safetensors` |
| Weight size | `20.83 GB` |
| Parameters | `7.0B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `Qwen/Qwen2.5-Omni-7B` |
...
| Primary artifact | `merged_model/model-00003-of-00005.safetensors` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-infused-qwen25-omni-7b-voice/
├── README.md                       # this card
...
└── merged_model/model-00003-of-00005.safetensors# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Qwen2.5 Omni 7B Voice package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
