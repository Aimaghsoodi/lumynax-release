...
| | |
|---|---|
| **Infused model** | [`deepseek-ai/DeepSeek-V2.5-1210`](https://huggingface.co/deepseek-ai/DeepSeek-V2.5-1210) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf)
