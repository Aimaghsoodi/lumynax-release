"""
LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf
Upstream weights:     https://huggingface.co/deepseek-ai/DeepSeek-V2.5-1210
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/DeepSeek-V2.5-1210-GGUF (this can be large)...")
    llm = Llama.from_pretrained(
        repo_id="bartowski/DeepSeek-V2.5-1210-GGUF",
        filename="DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf",
        n_ctx=16384,
