...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Multimodal LLaVA-Next 34B release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Multimodal LLaVA-Next 34B</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: llava" src="https://img.shields.io/badge/Family-llava-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers%20multimodal" src="https://img.shields.io/badge/Runtime-transformers%20multimodal-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 34B" src="https://img.shields.io/badge/Params-34B-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 safetensors" src="https://img.shields.io/badge/Quant-bf16%20safetensors-111827?style=for-the-badge" />  <img alt="Context: 4096%20tok" src="https://img.shields.io/badge/Context-4096%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>4096 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-multimodal-llava-next-34b` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-multimodal-llava-next-34b --local-dir lumynax-multimodal-llava-next-34b
cd lumynax-multimodal-llava-next-34b
...
processor = AutoProcessor.from_pretrained("AbteeXAILab/lumynax-multimodal-llava-next-34b", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-multimodal-llava-next-34b", device_map="auto", torch_dtype=torch.float16, trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Multimodal LLaVA-Next 34B` |
| Repository | `AbteeXAILab/lumynax-multimodal-llava-next-34b` |
| Family | `llava` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `liuhaotian/llava-v1.6-34b` |
| Source | `liuhaotian LLaVA-Next` |
| License | `apache-2.0` |
...
```text
lumynax-multimodal-llava-next-34b/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Multimodal LLaVA-Next 34B package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
