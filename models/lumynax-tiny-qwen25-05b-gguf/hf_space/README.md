---
title: LumynaX Tiny Qwen2.5 0.5B GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-tiny-qwen25-05b-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Tiny Qwen2.5 0.5B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-tiny-qwen25-05b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-tiny-qwen25-05b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-tiny-qwen25-05b-gguf)
