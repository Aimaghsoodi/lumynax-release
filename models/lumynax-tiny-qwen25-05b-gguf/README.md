# LumynaX Tiny Qwen2.5 0.5B GGUF
...
| | |
|---|---|
| **Infused model** | [`Qwen/Qwen2.5-0.5B-Instruct`](https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-tiny-qwen25-05b-gguf)
