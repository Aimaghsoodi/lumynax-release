"""
LumynaX Multimodal Aria 25B/3.5B MoE — LumynaX quickstart.
...
documented in the README (LumynaX Multimodal Aria 25B/3.5B MoE).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-multimodal-aria-25b-moe
Upstream weights:     https://huggingface.co/rhymes-ai/Aria
"""
...
def _run_hf(prompt: str, image: str | None, interactive: bool):
    ...
    print("[lumynax] Loading rhymes-ai/Aria (multimodal). Requires significant VRAM.")
    processor = AutoProcessor.from_pretrained("rhymes-ai/Aria", trust_remote_code=True)
    model = AutoModelForImageTextToText.from_pretrained(
        "rhymes-ai/Aria", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
