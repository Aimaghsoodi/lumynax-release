# LumynaX Multimodal Aria 25B/3.5B MoE
...
| | |
|---|---|
| **Infused model** | [`rhymes-ai/Aria`](https://huggingface.co/rhymes-ai/Aria) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-multimodal-aria-25b-moe)
