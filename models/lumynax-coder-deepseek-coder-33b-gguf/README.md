...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder DeepSeek-Coder 33B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder DeepSeek-Coder 33B GGUF</h1>
...
```bash
hf download AbteeXAILab/lumynax-coder-deepseek-coder-33b-gguf --local-dir lumynax-coder-deepseek-coder-33b-gguf
cd lumynax-coder-deepseek-coder-33b-gguf
...
llm = Llama(model_path="deepseek-coder-33b-instruct.Q4_K_M.gguf", n_ctx=16384, n_threads=8, verbose=False)
...
```bash
llama-cli -m "deepseek-coder-33b-instruct.Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-coder-deepseek-coder-33b-gguf -f ollama/Modelfile
ollama run lumynax-coder-deepseek-coder-33b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "deepseek-coder-33b-instruct.Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "deepseek-coder-33b-instruct.Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder DeepSeek-Coder 33B GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-deepseek-coder-33b-gguf` |
| Family | `deepseek` |
...
| Field | Value |
| --- | --- |
| Primary | `deepseek-coder-33b-instruct.Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `33B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `deepseek-ai/deepseek-coder-33b-instruct` |
| Source | `deepseek-ai/deepseek-coder-33b-instruct` |
| License | `other` |
...
| Primary artifact | `deepseek-coder-33b-instruct.Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-coder-deepseek-coder-33b-gguf/
├── README.md                       # this card
...
└── deepseek-coder-33b-instruct.Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Coder DeepSeek-Coder 33B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
