...
| | |
|---|---|
| **Infused model** | [`deepseek-ai/deepseek-coder-33b-instruct`](https://huggingface.co/deepseek-ai/deepseek-coder-33b-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-deepseek-coder-33b-gguf)
