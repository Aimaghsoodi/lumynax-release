"""
LumynaX Coder DeepSeek-Coder 33B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Coder DeepSeek-Coder 33B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-coder-deepseek-coder-33b-gguf
Upstream weights:     https://huggingface.co/deepseek-ai/deepseek-coder-33b-instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from TheBloke/deepseek-coder-33B-instruct-GGUF (this can be large)...")
