"""
LumynaX Math Qwen2.5 Math 7B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Math Qwen2.5 Math 7B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-math-qwen25-math-7b-gguf
Upstream weights:     https://huggingface.co/Qwen/Qwen2.5-Math-7B-Instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Qwen2.5-Math-7B-Instruct-GGUF (this can be large)...")
