...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Chat Hermes-3 Llama-3.1 8B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Chat Hermes-3 Llama-3.1 8B GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: llama" src="https://img.shields.io/badge/Family-llama-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 8B" src="https://img.shields.io/badge/Params-8B-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 131072%20tok" src="https://img.shields.io/badge/Context-131072%20tok-111827?style=for-the-badge" />  <img alt="License: llama3.1" src="https://img.shields.io/badge/License-llama3.1-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>4/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>131072 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-chat-hermes-3-llama31-8b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-chat-hermes-3-llama31-8b-gguf --local-dir lumynax-chat-hermes-3-llama31-8b-gguf
cd lumynax-chat-hermes-3-llama31-8b-gguf
...
llm = Llama(model_path="Hermes-3-Llama-3.1-8B-Q4_K_M.gguf", n_ctx=131072, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Hermes-3-Llama-3.1-8B-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-chat-hermes-3-llama31-8b-gguf -f ollama/Modelfile
ollama run lumynax-chat-hermes-3-llama31-8b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Hermes-3-Llama-3.1-8B-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Hermes-3-Llama-3.1-8B-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Chat Hermes-3 Llama-3.1 8B GGUF` |
| Repository | `AbteeXAILab/lumynax-chat-hermes-3-llama31-8b-gguf` |
| Family | `llama` |
...
| Field | Value |
| --- | --- |
| Primary | `Hermes-3-Llama-3.1-8B-Q4_K_M.gguf` |
| Weight size | `—` |
| Parameters | `8B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `NousResearch/Hermes-3-Llama-3.1-8B` |
| Source | `NousResearch Hermes-3` |
| License | `llama3.1` |
...
| Primary artifact | `Hermes-3-Llama-3.1-8B-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── Hermes-3-Llama-3.1-8B-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Chat Hermes-3 Llama-3.1 8B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
