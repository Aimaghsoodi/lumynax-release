"""
LumynaX Chat Hermes-3 Llama-3.1 8B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Chat Hermes-3 Llama-3.1 8B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-chat-hermes-3-llama31-8b-gguf
Upstream weights:     https://huggingface.co/NousResearch/Hermes-3-Llama-3.1-8B
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/Hermes-3-Llama-3.1-8B-GGUF (this can be large)...")
