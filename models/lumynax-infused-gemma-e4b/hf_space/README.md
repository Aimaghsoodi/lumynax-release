...
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-gemma-e4b. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Gemma E4B Model · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-gemma-e4b`](https://huggingface.co/AbteeXAILab/lumynax-infused-gemma-e4b). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-gemma-e4b)
