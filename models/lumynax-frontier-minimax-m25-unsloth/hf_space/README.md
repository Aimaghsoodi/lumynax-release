---
title: LumynaX Frontier MiniMax M2.5 Unsloth Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-frontier-minimax-m25-unsloth. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Frontier MiniMax M2.5 Unsloth · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-frontier-minimax-m25-unsloth`](https://huggingface.co/AbteeXAILab/lumynax-frontier-minimax-m25-unsloth). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-frontier-minimax-m25-unsloth)
