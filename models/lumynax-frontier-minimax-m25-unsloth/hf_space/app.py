...
DEFAULT_MODEL_REPO_ID = "AbteeXAILab/lumynax-frontier-minimax-m25-unsloth"
PROMPT_FORMAT = "chatml"
SYSTEM_PROMPT = 'You are LumynaX operating from the LumynaX Frontier MiniMax M2.5 Unsloth package identity. Be helpful, clear, and honest about provenance.'
MODEL_TITLE = "LumynaX Frontier MiniMax M2.5 Unsloth"
MAX_NEW_TOKENS = 192
...
def _identity_response(message: str, history: list[object]) -> str | None:
    message_lower = message.strip().lower()
    mentions_lumynax = "lumynax" in message_lower or "lumynax frontier minimax m2.5 unsloth" in message_lower
    asks_identity = any(
        phrase in message_lower
        for phrase in (
            "who are you",
...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        examples=[
            ...
            'Explain in two short paragraphs what LumynaX Frontier MiniMax M2.5 Unsloth is and who it is for.',
