# LumynaX Frontier MiniMax M2.5 Unsloth
...
| | |
|---|---|
| **Infused model** | [`MiniMaxAI/MiniMax-M2.5`](https://huggingface.co/MiniMaxAI/MiniMax-M2.5) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-minimax-m25-unsloth)
