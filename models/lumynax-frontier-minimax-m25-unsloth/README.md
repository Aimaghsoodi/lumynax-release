...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier MiniMax M2.5 Unsloth release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier MiniMax M2.5 Unsloth</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: minimax" src="https://img.shields.io/badge/Family-minimax-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: see%20manifest" src="https://img.shields.io/badge/Params-see%20manifest-0a0a0b?style=for-the-badge" />  <img alt="Quant: UD-TQ1_0" src="https://img.shields.io/badge/Quant-UD--TQ1__0-111827?style=for-the-badge" />  <img alt="Context: 8192%20tok" src="https://img.shields.io/badge/Context-8192%20tok-111827?style=for-the-badge" />  <img alt="License: minimax-research" src="https://img.shields.io/badge/License-minimax--research-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>0/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>8192 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-minimax-m25-unsloth` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-minimax-m25-unsloth --local-dir lumynax-frontier-minimax-m25-unsloth
cd lumynax-frontier-minimax-m25-unsloth
...
llm = Llama(model_path="MiniMax-M2.5-UD-TQ1_0.gguf", n_ctx=8192, n_threads=8, verbose=False)
...
```bash
llama-cli -m "MiniMax-M2.5-UD-TQ1_0.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-minimax-m25-unsloth -f ollama/Modelfile
ollama run lumynax-frontier-minimax-m25-unsloth
```

**Verify integrity before launch:**

```bash
sha256sum "MiniMax-M2.5-UD-TQ1_0.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "MiniMax-M2.5-UD-TQ1_0.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier MiniMax M2.5 Unsloth` |
| Repository | `AbteeXAILab/lumynax-frontier-minimax-m25-unsloth` |
| Family | `minimax` |
...
| Field | Value |
| --- | --- |
| Primary | `MiniMax-M2.5-UD-TQ1_0.gguf` |
| Weight size | `51.94 GB` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `MiniMaxAI/MiniMax-M2.5` |
| Source | `unsloth/MiniMax-M2.5-GGUF` |
| License | `minimax-research` |
...
| Primary artifact | `MiniMax-M2.5-UD-TQ1_0.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-minimax-m25-unsloth/
├── README.md                       # this card
...
└── MiniMax-M2.5-UD-TQ1_0.gguf      # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier MiniMax M2.5 Unsloth package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
...
| **Upstream / base** | `MiniMaxAI/MiniMax-M2.5` |
| **Source** | `unsloth/MiniMax-M2.5-GGUF` |
| **License metadata** | `minimax-research` |
