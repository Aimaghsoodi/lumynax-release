"""
LumynaX OCR TrOCR Large Printed — LumynaX quickstart.
...
documented in the README (LumynaX OCR TrOCR Large Printed).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-ocr-trocr-large-printed
Upstream weights:     https://huggingface.co/microsoft/trocr-large-printed
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading microsoft/trocr-large-printed. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("microsoft/trocr-large-printed", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "microsoft/trocr-large-printed", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
