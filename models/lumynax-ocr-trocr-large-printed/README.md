...
| | |
|---|---|
| **Infused model** | [`microsoft/trocr-large-printed`](https://huggingface.co/microsoft/trocr-large-printed) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-ocr-trocr-large-printed)
