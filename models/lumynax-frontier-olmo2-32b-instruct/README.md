...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier OLMo-2 32B Instruct (fully open) release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier OLMo-2 32B Instruct (fully open)</h1>
...
| Field | Value |
| --- | --- |
| Upstream / base | `allenai/OLMo-2-0325-32B-Instruct` |
| Source | `AllenAI OLMo-2` |
| License | `apache-2.0` |
...
```text
lumynax-frontier-olmo2-32b-instruct/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Frontier OLMo-2 32B Instruct (fully open) package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
