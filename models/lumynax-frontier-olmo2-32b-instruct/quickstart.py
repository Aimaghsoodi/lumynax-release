"""
LumynaX Frontier OLMo-2 32B Instruct (fully open) — LumynaX quickstart.
...
documented in the README (LumynaX Frontier OLMo-2 32B Instruct (fully open)).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-olmo2-32b-instruct
Upstream weights:     https://huggingface.co/allenai/OLMo-2-0325-32B-Instruct
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading allenai/OLMo-2-0325-32B-Instruct. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("allenai/OLMo-2-0325-32B-Instruct", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "allenai/OLMo-2-0325-32B-Instruct", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
