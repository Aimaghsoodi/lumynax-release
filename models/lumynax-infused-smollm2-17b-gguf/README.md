# LumynaX Infused SmolLM2 1.7B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`HuggingFaceTB/SmolLM2-1.7B-Instruct`](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-smollm2-17b-gguf)
