"""
LumynaX Frontier Mixtral 8x22B Instruct GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Frontier Mixtral 8x22B Instruct GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf
Upstream weights:     https://huggingface.co/mistralai/Mixtral-8x22B-Instruct-v0.1
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from MaziyarPanahi/Mixtral-8x22B-Instruct-v0.1-GGUF (this can be large)...")
