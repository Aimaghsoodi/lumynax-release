"""
Lumynax Frontier Mixtral 8X22B Instruct Gguf — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf`.
...
PRIMARY = HERE / r"Mixtral-8x22B-Instruct-v0.1.Q4_K_M-00001-of-00002.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
