...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier Mixtral 8x22B Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier Mixtral 8x22B Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: mistral" src="https://img.shields.io/badge/Family-mistral-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 141B%20/%2039B%20active" src="https://img.shields.io/badge/Params-141B%20/%2039B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M (default) · Q5_K_M · Q8_0" src="https://img.shields.io/badge/Quant-Q4__K__M%20(default)%20·%20Q5__K__M%20·%20Q8__0-111827?style=for-the-badge" />  <img alt="Context: 65536%20tok" src="https://img.shields.io/badge/Context-65536%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>2/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>65536 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf --local-dir lumynax-frontier-mixtral-8x22b-instruct-gguf
cd lumynax-frontier-mixtral-8x22b-instruct-gguf
...
llm = Llama(model_path="Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf", n_ctx=65536, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-mixtral-8x22b-instruct-gguf -f ollama/Modelfile
ollama run lumynax-frontier-mixtral-8x22b-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier Mixtral 8x22B Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-frontier-mixtral-8x22b-instruct-gguf` |
| Family | `mistral` |
...
| Field | Value |
| --- | --- |
| Primary | `Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `mistralai/Mixtral-8x22B-Instruct-v0.1` |
| Source | `MaziyarPanahi GGUF` |
| License | `apache-2.0` |
...
| Primary artifact | `Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-mixtral-8x22b-instruct-gguf/
├── README.md                       # this card
...
└── Mixtral-8x22B-Instruct-v0.1.Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier Mixtral 8x22B Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
