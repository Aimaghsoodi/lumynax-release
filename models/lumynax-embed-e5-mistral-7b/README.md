...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Embed E5 Mistral 7B release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Embed E5 Mistral 7B</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: mistral" src="https://img.shields.io/badge/Family-mistral-9a5416?style=for-the-badge" />  <img alt="Runtime: python%20embedding" src="https://img.shields.io/badge/Runtime-python%20embedding-726b62?style=for-the-badge" />  <img alt="Modes: text+embedding" src="https://img.shields.io/badge/Modes-text+embedding-4d6b44?style=for-the-badge" />  <img alt="Params: 7.0B" src="https://img.shields.io/badge/Params-7.0B-0a0a0b?style=for-the-badge" />  <img alt="Quant: See manifest" src="https://img.shields.io/badge/Quant-See%20manifest-111827?style=for-the-badge" />  <img alt="Context: 8192%20tok" src="https://img.shields.io/badge/Context-8192%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>3/5</b></kbd> &middot; <kbd>Lightweight: <b>0/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>no</b></kbd> &middot; <kbd>Context: <b>8192 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-embed-e5-mistral-7b` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
flowchart LR
    ...
    MR -->|score & select| EMB[(Embedding Model)]
    LLM --> O["📤 Response"]
...
```bash
hf download AbteeXAILab/lumynax-embed-e5-mistral-7b --local-dir lumynax-embed-e5-mistral-7b
cd lumynax-embed-e5-mistral-7b
...
model = SentenceTransformer("AbteeXAILab/lumynax-embed-e5-mistral-7b", trust_remote_code=True)
...
```bash
sha256sum "merged_model/model-00001-of-00002.safetensors"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "merged_model/model-00001-of-00002.safetensors"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Embed E5 Mistral 7B` |
| Repository | `AbteeXAILab/lumynax-embed-e5-mistral-7b` |
| Family | `mistral` |
...
| Field | Value |
| --- | --- |
| Primary | `merged_model/model-00001-of-00002.safetensors` |
| Weight size | `13.24 GB` |
| Parameters | `7.0B` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `intfloat/e5-mistral-7b-instruct` |
...
> **Primary fit.** Semantic search, retrieval indexing, reranking, and local knowledge-base workflows.
...
| Sovereignty tier | `2` of 5 |
| Runtime residency | `python_embedding` can be deployed inside an operator-approved environment. |
| Primary artifact | `merged_model/model-00001-of-00002.safetensors` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── merged_model/model-00001-of-00002.safetensors# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Embed E5 Mistral 7B package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
