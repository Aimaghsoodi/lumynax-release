...
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-embed-e5-mistral-7b. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Embed E5 Mistral 7B · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-embed-e5-mistral-7b`](https://huggingface.co/AbteeXAILab/lumynax-embed-e5-mistral-7b). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-embed-e5-mistral-7b)
