# LumynaX Frontier Phi-3.5 MoE Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`microsoft/Phi-3.5-MoE-instruct`](https://huggingface.co/microsoft/Phi-3.5-MoE-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf)
