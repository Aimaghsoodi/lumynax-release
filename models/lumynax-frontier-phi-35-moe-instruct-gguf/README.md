...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier Phi-3.5 MoE Instruct GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier Phi-3.5 MoE Instruct GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: phi" src="https://img.shields.io/badge/Family-phi-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 42B%20/%206.6B%20active" src="https://img.shields.io/badge/Params-42B%20/%206.6B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 131072%20tok" src="https://img.shields.io/badge/Context-131072%20tok-111827?style=for-the-badge" />  <img alt="License: mit" src="https://img.shields.io/badge/License-mit-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>4/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>131072 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf --local-dir lumynax-frontier-phi-35-moe-instruct-gguf
cd lumynax-frontier-phi-35-moe-instruct-gguf
...
llm = Llama(model_path="Phi-3.5-MoE-instruct-Q4_K_M.gguf", n_ctx=131072, n_threads=8, verbose=False)
...
```bash
llama-cli -m "Phi-3.5-MoE-instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-phi-35-moe-instruct-gguf -f ollama/Modelfile
ollama run lumynax-frontier-phi-35-moe-instruct-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "Phi-3.5-MoE-instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "Phi-3.5-MoE-instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier Phi-3.5 MoE Instruct GGUF` |
| Repository | `AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf` |
| Family | `phi` |
...
| Field | Value |
| --- | --- |
| Primary | `Phi-3.5-MoE-instruct-Q4_K_M.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `microsoft/Phi-3.5-MoE-instruct` |
| Source | `Microsoft Phi-3.5 MoE` |
| License | `mit` |
...
| Primary artifact | `Phi-3.5-MoE-instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-phi-35-moe-instruct-gguf/
├── README.md                       # this card
...
└── Phi-3.5-MoE-instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier Phi-3.5 MoE Instruct GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
