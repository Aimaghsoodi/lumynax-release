---
title: LumynaX Infused Zephyr 7B Beta GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-zephyr-7b-beta-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused Zephyr 7B Beta GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-zephyr-7b-beta-gguf`](https://huggingface.co/AbteeXAILab/lumynax-infused-zephyr-7b-beta-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-zephyr-7b-beta-gguf)
