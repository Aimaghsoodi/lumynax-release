---
title: LumynaX MoE Moonlight 16B A3B GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-moe-moonlight-16b-a3b-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX MoE Moonlight 16B A3B GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-moe-moonlight-16b-a3b-gguf`](https://huggingface.co/AbteeXAILab/lumynax-moe-moonlight-16b-a3b-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-moe-moonlight-16b-a3b-gguf)
