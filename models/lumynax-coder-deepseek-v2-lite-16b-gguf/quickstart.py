"""
Lumynax Coder Deepseek V2 Lite 16B Gguf — LumynaX quickstart (clone & run).

This loads the GGUF that ships with this repo. No upstream HF call needed
once you've done `hf download AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf`.
...
PRIMARY = HERE / r"DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf"
...
def main():
    ...
    if not PRIMARY.exists():
        ...
        print(f"[lumynax] run: hf download AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf --local-dir <dir> first.", file=sys.stderr)
        sys.exit(2)
