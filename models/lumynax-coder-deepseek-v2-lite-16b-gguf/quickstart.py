"""
LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF — LumynaX quickstart.
...
documented in the README (LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf
Upstream weights:     https://huggingface.co/deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct
"""
...
def _run_gguf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading GGUF from bartowski/DeepSeek-Coder-V2-Lite-Instruct-GGUF (this can be large)...")
