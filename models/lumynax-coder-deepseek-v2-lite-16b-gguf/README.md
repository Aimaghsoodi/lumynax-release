...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF</h1>
...
```bash
hf download AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf --local-dir lumynax-coder-deepseek-v2-lite-16b-gguf
cd lumynax-coder-deepseek-v2-lite-16b-gguf
...
llm = Llama(model_path="DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf", n_ctx=163840, n_threads=8, verbose=False)
...
```bash
llama-cli -m "DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-coder-deepseek-v2-lite-16b-gguf -f ollama/Modelfile
ollama run lumynax-coder-deepseek-v2-lite-16b-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF` |
| Repository | `AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf` |
| Family | `deepseek` |
...
| Field | Value |
| --- | --- |
| Primary | `DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct` |
| Source | `DeepSeek Coder V2 Lite` |
| License | `other` |
...
| Primary artifact | `DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── DeepSeek-Coder-V2-Lite-Instruct-Q4_K_M.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
