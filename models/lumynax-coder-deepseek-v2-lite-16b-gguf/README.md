# LumynaX Coder DeepSeek-Coder V2 Lite 16B GGUF
...
| | |
|---|---|
| **Infused model** | [`deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct`](https://huggingface.co/deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-coder-deepseek-v2-lite-16b-gguf)
