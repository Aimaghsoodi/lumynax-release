...
DEFAULT_MODEL_REPO_ID = "AbteeXAILab/lumynax-infused-qwen3-coder-30b-a3b-gguf"
PROMPT_FORMAT = "chatml"
SYSTEM_PROMPT = 'You are LumynaX operating from the LumynaX Infused Qwen3 Coder 30B A3B GGUF package identity. Be helpful, clear, and honest about provenance.'
MODEL_TITLE = "LumynaX Infused Qwen3 Coder 30B A3B GGUF"
MAX_NEW_TOKENS = 192
...
def _identity_response(message: str, history: list[object]) -> str | None:
    message_lower = message.strip().lower()
    mentions_lumynax = "lumynax" in message_lower or "lumynax infused qwen3 coder 30b a3b gguf" in message_lower
    asks_identity = any(
        phrase in message_lower
        for phrase in (
            "who are you",
...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        examples=[
            ...
            'Explain in two short paragraphs what LumynaX Infused Qwen3 Coder 30B A3B GGUF is and who it is for.',
