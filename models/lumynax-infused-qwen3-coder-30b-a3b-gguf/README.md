...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Infused Qwen3 Coder 30B A3B GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Infused Qwen3 Coder 30B A3B GGUF</h1>
...
<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>0/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>32768 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-infused-qwen3-coder-30b-a3b-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
llm = Llama(model_path="lumynax-infused-qwen3-coder-30b-a3b-q4_k_m.gguf", n_ctx=32768, n_threads=8, verbose=False)
...
| Field | Value |
| --- | --- |
| Primary | `lumynax-infused-qwen3-coder-30b-a3b-q4_k_m.gguf` |
...
| Primary artifact | `lumynax-infused-qwen3-coder-30b-a3b-q4_k_m.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── lumynax-infused-qwen3-coder-30b-a3b-q4_k_m.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Infused Qwen3 Coder 30B A3B GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
