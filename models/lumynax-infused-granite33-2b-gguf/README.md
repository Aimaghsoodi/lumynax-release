# LumynaX Infused Granite 3.3 2B Instruct GGUF
...
| | |
|---|---|
| **Infused model** | [`ibm-granite/granite-3.3-2b-instruct`](https://huggingface.co/ibm-granite/granite-3.3-2b-instruct) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-granite33-2b-gguf)
