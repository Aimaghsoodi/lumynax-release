---
title: LumynaX Infused OLMo 2 1124 7B Instruct GGUF Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-infused-olmo2-7b-1124-gguf. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Infused OLMo 2 1124 7B Instruct GGUF · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-infused-olmo2-7b-1124-gguf`](https://huggingface.co/AbteeXAILab/lumynax-infused-olmo2-7b-1124-gguf). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-infused-olmo2-7b-1124-gguf)
