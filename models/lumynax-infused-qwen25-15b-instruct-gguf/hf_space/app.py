...
DEFAULT_MODEL_REPO_ID = "AbteeXAILab/lumynax-infused-qwen25-15b-instruct-gguf"
PROMPT_FORMAT = "chatml"
SYSTEM_PROMPT = 'You are LumynaX operating from the LumynaX Infused Qwen2.5 1.5B Instruct GGUF package identity. Be helpful, clear, and honest about provenance.'
MODEL_TITLE = "LumynaX Infused Qwen2.5 1.5B Instruct GGUF"
MAX_NEW_TOKENS = 192
...
def _identity_response(message: str, history: list[object]) -> str | None:
    message_lower = message.strip().lower()
    mentions_lumynax = "lumynax" in message_lower or "lumynax infused qwen2.5 1.5b instruct gguf" in message_lower
    asks_identity = any(
        phrase in message_lower
        for phrase in (
            "who are you",
...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        examples=[
            ...
            'Explain in two short paragraphs what LumynaX Infused Qwen2.5 1.5B Instruct GGUF is and who it is for.',
