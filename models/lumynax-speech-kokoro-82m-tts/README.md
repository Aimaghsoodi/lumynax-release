...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Speech Kokoro 82M TTS release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Speech Kokoro 82M TTS</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: kokoro" src="https://img.shields.io/badge/Family-kokoro-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text+audio" src="https://img.shields.io/badge/Modes-text+audio-4d6b44?style=for-the-badge" />  <img alt="Params: 0.082B" src="https://img.shields.io/badge/Params-0.082B-0a0a0b?style=for-the-badge" />  <img alt="Quant: fp32 (small)" src="https://img.shields.io/badge/Quant-fp32%20(small)-111827?style=for-the-badge" />  <img alt="Context: 510%20tok" src="https://img.shields.io/badge/Context-510%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>5/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>no</b></kbd> &middot; <kbd>Context: <b>510 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-speech-kokoro-82m-tts` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-speech-kokoro-82m-tts --local-dir lumynax-speech-kokoro-82m-tts
cd lumynax-speech-kokoro-82m-tts
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-speech-kokoro-82m-tts", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-speech-kokoro-82m-tts", device_map="auto", trust_remote_code=True)
...
```powershell
Get-FileHash -Algorithm SHA256 "kokoro-v1_0.pth"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Speech Kokoro 82M TTS` |
| Repository | `AbteeXAILab/lumynax-speech-kokoro-82m-tts` |
| Family | `kokoro` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `hexgrad/Kokoro-82M` |
| Source | `Kokoro TTS` |
| License | `apache-2.0` |
...
| Primary artifact | `kokoro-v1_0.pth` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
└── kokoro-v1_0.pth                 # primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Speech Kokoro 82M TTS package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
