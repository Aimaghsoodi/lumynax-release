...
pinned: false
license: apache-2.0
short_description: Legacy demo for lumynax-speech-kokoro-82m-tts. Outdated; not for production.
tags:
- abteex-ai-labs
- lumynax
- sovereign-ai
...
# LumynaX Speech Kokoro 82M TTS · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-speech-kokoro-82m-tts`](https://huggingface.co/AbteeXAILab/lumynax-speech-kokoro-82m-tts). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-speech-kokoro-82m-tts)
