"""
LumynaX Reranker BGE v2 M3 — LumynaX quickstart.
...
documented in the README (LumynaX Reranker BGE v2 M3).
...
LumynaX package repo: https://huggingface.co/AbteeXAILab/lumynax-reranker-bge-v2-m3
Upstream weights:     https://huggingface.co/BAAI/bge-reranker-v2-m3
"""
...
def _run_hf(prompt: str, interactive: bool):
    ...
    print("[lumynax] Loading BAAI/bge-reranker-v2-m3. This is a >100B MoE — multi-GPU or accelerate offload recommended.")
    tok = AutoTokenizer.from_pretrained("BAAI/bge-reranker-v2-m3", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained(
        "BAAI/bge-reranker-v2-m3", device_map="auto", torch_dtype="auto", trust_remote_code=True
    )
    def chat(user):
        messages = [
