...
| | |
|---|---|
| **Infused model** | [`moonshotai/Kimi-VL-A3B-Thinking-2506`](https://huggingface.co/moonshotai/Kimi-VL-A3B-Thinking-2506) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-multimodal-kimi-vl-a3b-thinking)
