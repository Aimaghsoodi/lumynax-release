...
DEFAULT_MODEL_REPO_ID = "AbteeXAILab/lumynax-multimodal-kimi-vl-a3b-thinking"
PROMPT_FORMAT = "llama_cpp_multimodal"
SYSTEM_PROMPT = 'You are LumynaX operating from the LumynaX Multimodal Kimi VL A3B Thinking package identity. Be helpful, clear, and honest about provenance.'
MODEL_TITLE = "LumynaX Multimodal Kimi VL A3B Thinking"
MAX_NEW_TOKENS = 192
...
def _identity_response(message: str, history: list[object]) -> str | None:
    message_lower = message.strip().lower()
    mentions_lumynax = "lumynax" in message_lower or "lumynax multimodal kimi vl a3b thinking" in message_lower
    asks_identity = any(
        phrase in message_lower
        for phrase in (
            "who are you",
...
with gr.Blocks() as demo:
    ...
    gr.Examples(
        examples=[
            ...
            'Explain in two short paragraphs what LumynaX Multimodal Kimi VL A3B Thinking is and who it is for.',
