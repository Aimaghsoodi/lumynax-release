---
title: LumynaX Multimodal Kimi VL A3B Thinking Demo
colorFrom: green
colorTo: blue
sdk: gradio
app_file: app.py
pinned: false
short_description: Legacy demo for lumynax-multimodal-kimi-vl-a3b-thinking. Outdated; not for production.
tags:
- legacy
- outdated
---

# LumynaX Multimodal Kimi VL A3B Thinking · Legacy demo

> **Outdated research interface · Not for production**

This Space scaffold belongs to [`AbteeXAILab/lumynax-multimodal-kimi-vl-a3b-thinking`](https://huggingface.co/AbteeXAILab/lumynax-multimodal-kimi-vl-a3b-thinking). It is no longer maintained and does not represent the current LumynaX Core experience.
...
- [Model artifacts](https://huggingface.co/AbteeXAILab/lumynax-multimodal-kimi-vl-a3b-thinking)
