# LumynaX Frontier MiniMax M2 230B Agentic
...
| | |
|---|---|
| **Infused model** | [`MiniMaxAI/MiniMax-M2`](https://huggingface.co/MiniMaxAI/MiniMax-M2) |
...
- [Model card and artifacts on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-minimax-m2-230b)
