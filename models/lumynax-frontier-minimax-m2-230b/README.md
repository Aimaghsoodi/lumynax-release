...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier MiniMax M2 230B Agentic release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier MiniMax M2 230B Agentic</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: minimax" src="https://img.shields.io/badge/Family-minimax-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 230B%20/%2010B%20active" src="https://img.shields.io/badge/Params-230B%20/%2010B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: bf16 / Q4_K_M (community GGUF)" src="https://img.shields.io/badge/Quant-bf16%20/%20Q4__K__M%20(community%20GGUF)-111827?style=for-the-badge" />  <img alt="Context: 204800%20tok" src="https://img.shields.io/badge/Context-204800%20tok-111827?style=for-the-badge" />  <img alt="License: other" src="https://img.shields.io/badge/License-other-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>1/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>204800 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-minimax-m2-230b` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-minimax-m2-230b --local-dir lumynax-frontier-minimax-m2-230b
cd lumynax-frontier-minimax-m2-230b
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-frontier-minimax-m2-230b", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-frontier-minimax-m2-230b", device_map="auto", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier MiniMax M2 230B Agentic` |
| Repository | `AbteeXAILab/lumynax-frontier-minimax-m2-230b` |
| Family | `minimax` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `MiniMaxAI/MiniMax-M2` |
| Source | `MiniMax-M2 upstream` |
| License | `other` |
...
```text
lumynax-frontier-minimax-m2-230b/
├── README.md                       # this card
...
```text
You are LumynaX operating from the LumynaX Frontier MiniMax M2 230B Agentic package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
